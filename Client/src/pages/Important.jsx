...
const Important = () => {
    ...
    useEffect(() => {
        const getTodos = async () => {
            try {
                const response = await getTodo('Important');
    ...
    return (
        <div>
            ...
            {form && (
                <TodoForm setForm={setForm} setTodos={setTodos} category="Important" />
            )}

            {editForm && editTodo && (
                <TodoForm setForm={setEditForm} setTodos={setTodos} editTodo={editTodo} onEditSubmit={handleEditSubmit} category="Important" />
            )}
        </div>
    )
}
